            ...
            <form action="{{ route('activity.store') }}" method="POST">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <input type="number" class="form-control" name="hours" id="hours" required value="{{ old('hours') }}" min="0" step="0.01">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-lg-6 mb-4">
                        ...
                        <select name="type_activity_id" id="type_activity_id" class="form-control">
                            <option value="">Seleccione</option>
                             @foreach ($types as $type)
                                <option value="{{ $type['id'] }}" @if (old('type_activity_id') == $type['id']) selected @endif>
                                    {{ $type['description'] }}
                                </option>
                            @endforeach
                        </select>
