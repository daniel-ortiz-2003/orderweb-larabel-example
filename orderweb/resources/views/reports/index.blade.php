...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 mb-4">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('reports.activities_by_technician') }}" method="POST">
                        @csrf
                        <div class="row form-group">
                            <div class="col-lg-2">
                                <label for="tecnician_id">Tecnico:</label>
                            </div>
                            <div class="col-lg-5">
                            ...
                            <div class="col-lg-5">
                                <button type="submit" class="btn btn-danger btn-block btn-lg col-lg-3" title="PDF">
                                    <i class="fa-solid fa-file-pdf"></i>
                                </button>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-lg-12 mb-4">
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Reporte orden por rango de fechas</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('reports.order_rank_date') }}" method="POST">
                        @csrf
                        <div class="row form-group">
                            <div class="col-lg-2">
